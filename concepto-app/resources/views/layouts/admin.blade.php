...
<head>
    ...
    <link rel="icon" href="<?= url('assets/svg/favicon.svg') ?>" />
...
<body>
    ...
    <header class="navbar m-0-auto">
        ...
        <nav>
            <ul id="primary-navigation" data-visible="false">
                @auth
                    ...
                    <li>
                        <a href="<?= route('admin.user') ?>" class="navigation-anchor">
                            <p>Usuarios</p>
                        </a>
                    </li>
                @endauth
        ...
        @auth
            <form action="{{ route('auth.admin.logout.process') }}" method="post">
                @csrf
                <button type="submit" class="navigation-anchor logout-button">Cerrar sesión</button>
            </form>
        @else
            <a href="<?= route('auth.admin.login.form') ?>" class="navigation-anchor">Iniciar sesión</a>
        @endauth
