...
@section('content')
    ...
    <section class="hero-section container mb-200">
        ...
        <div class="hero-section-content">
            <div class="hero-section-subtitle mb-16">
                ...
                <p>Cursos y tutoriales online</p>
            </div>
                    ...
                    <div class="icon-container mb-16">
                        <svg xmlns="http://www.w3.org/2000/svg" viewbox="0 0 48 48" fill="none" class="svg-medium">
                            <path fill="#2741E8" fill-rule="evenodd"
                                ...
                                clip-rule="evenodd" />
                            <path stroke="#2741E8" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10"
                                stroke-width="1.5"
    ...
    <section class="container w-100 categorias mb-201">
        ...
        <h2 class="h1 h1-bigger text-center max-600 m-0-auto mt-8 mb-24">Aprendé con los mejores tips de nuestra comunidad
        </h2>
        <p class="paragraph mb-8 text-center max-600 m-0-auto mb-40">Desde nuestros tutoriales hasta nuestro blog, en
            concepto estamos comprometidos con la idea de crear continuamente contenido de calidad para ayudarte a crecer
            profesionalmente.</p>
