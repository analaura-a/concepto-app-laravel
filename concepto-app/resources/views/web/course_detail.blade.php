...
<section class="container mt-32 mb-100">
    ...
    <a href="<?= route('web.courses') ?>" class="go-back mb-32">
        <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="none" viewbox="0 0 48 48">
            <path stroke="#3E4B62" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="m28 33.5-7.35-7.82c-.867-.924-.867-2.436 0-3.36L28 14.5" />
        </svg>
    ...
    <div class="course-container">
        <div class="course-information">
            ...
            <a href="https://www.youtube.com/watch?v=dQw4w9WgXcQ&ab_channel=RickAstley" target="_blank" class="mb-48">
                <div id="course-image" style="background-image: linear-gradient(180deg, rgba(42, 43, 46, 0.51) 73.31%, rgba(60, 61, 66, 0.37) 100%), url(<?= url('assets/' . $course->cover) ?>); background-repeat: no-repeat; background-position: center; background-size: cover;">
                </div>
            </a>
                ...
                <ul id="course-learnings">
                    ...
                    <li class="learning">
                        <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" fill="none" viewbox="0 0 48 48">
                            <path stroke="#8BA5FF" stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="m12 27.167 6 6.333 18-19" />
                        </svg>
            ...
            <div class="pb-40 separador">
                ...
                <a href="<?= route('web.cart.add', ['id' => $course->course_id]) ?>" class="main-cta" id="mainCTA">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewbox="0 0 48 48" fill="none">
                        <path stroke="#fff" stroke-linecap="round" stroke-width="2" d="m12.5 13.15 1.93.386a1.38 1.38 0 0 1 1.102 1.215l.25 2.502m0 0 1.261 10.507a1.38 1.38 0 0 0 1.37 1.215H31.13a2.413 2.413 0 0 0 2.341-1.828l1.98-7.924a1.586 1.586 0 0 0-1.538-1.97h-18.13Z" />
                        <path stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20.706 25.459h4.688" />
                        <path fill="#fff" d="M21.878 33.078a1.758 1.758 0 1 1-3.517 0 1.758 1.758 0 0 1 3.517 0ZM32.428 33.078a1.758 1.758 0 1 1-3.517 0 1.758 1.758 0 0 1 3.517 0Z" />
                    </svg>
                </a>
            </div>
