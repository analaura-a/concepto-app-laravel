        ...
        <div class="course-container">
            <div class="course-information">
                ...
                <a href="https://www.youtube.com/watch?v=dQw4w9WgXcQ&ab_channel=RickAstley" target="_blank" class="mb-48">
                    <div id="course-image"
                        style="background-image: linear-gradient(180deg, rgba(42, 43, 46, 0.51) 73.31%, rgba(60, 61, 66, 0.37) 100%), url(<?= url('assets/' . $course->cover) ?>); background-repeat: no-repeat; background-position: center; background-size: cover;">
                    </div>
                </a>
                ...
                <div class="pb-40 pt-40 separador">
                    ...
                    <ul class="course-bullet-points">
                        <li>
                            ...
                            <p id="course-duration" class="paragraph">{{ $course->duration }} horas de video bajo demanda.
                            </p>
                        </li>
                        <li>
                            <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewbox="0 0 48 48"
