...
<section class="container w-100 mt-32 categorias pb-32">
    ...
    <h2 class="h1 h1-bigger text-center max-600 m-0-auto mt-8 mb-24">Encontrá los mejores consejos para potenciar tu carrera profesional</h2>
...
<section class="container mb-200" id="seccionTendencias">
    ...
    <ul class="container-cards mb-56">
        ...
        <li class="course-card">   
           <a href="#">
                <div class="card-img">
                    <img src="{{ $post->cover }}" alt="Design systems desde 0 en Figma">
                </div>
