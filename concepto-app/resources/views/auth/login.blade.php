...
<section class="container mt-100 mb-100 mb-201">
    ...
    <div class="checkout-form m-0-auto">
        ...
        <form action="<?= route('auth.login.process'); ?>" method="post" id="form-checkout">
            @csrf

            <div class="form-input">
                <label for="username">Nombre de usuario<span class="primary-color-text">*</span></label>
                <input type="text" id="username" name="username" placeholder="Usuario" @error('username') aria-describedby="error-username" @enderror value="{{ old('username') }}">
                @error('username')
            ...
            <div class="form-input">
                ...
                <input type="password" id="password" name="password" placeholder="**********" @error('password') aria-describedby="error-password" @enderror>
                @error('password')
