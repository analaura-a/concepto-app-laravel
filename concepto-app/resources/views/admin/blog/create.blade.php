...
@section('content')
    ...
    <section class="container mt-100 mb-100">
        ...
        <div class="checkout-form m-0-auto">
            ...
            <form action="<?= route('admin.blog.create.process') ?>" method="post" enctype="multipart/form-data"
                id="form-checkout">
                @csrf
                ...
                <div class="form-input">
                    ...
                    <input type="text" id="category" name="category" placeholder="Categoría"
                        @error('category') aria-describedby="error-category" @enderror value="{{ old('category') }}">
                    @error('category')
                ...
                <div class="form-input">
                    ...
                    <textarea id="summary" name="summary" rows="5" placeholder="Esta publicación habla de..."
                        @error('summary') aria-describedby="error-summary" @enderror>{{ old('summary') }}</textarea>
