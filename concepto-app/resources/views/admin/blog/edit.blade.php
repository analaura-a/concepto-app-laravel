    ...
    <div class="checkout-form m-0-auto">
        ...
        <form action="<?= route('admin.blog.edit.process', ['id' => $post->id]); ?>" method="post" enctype="multipart/form-data" id="form-checkout">
            ...
            <div class="form-input">
                ...
                <input type="text" id="category" name="category" placeholder="Categoría" @error('category') aria-describedby="error-category" @enderror value="{{ old('category', $post->category) }}">
                @error('category')
            ...
            <div class="form-input">
                ...
                <input type="text" id="title" name="title" placeholder="Título" @error('title') aria-describedby="error-title" @enderror value="{{ old('title', $post->title) }}">
                @error('title')
