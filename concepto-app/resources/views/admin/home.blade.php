...
@section('content')
    ...
    <section class="container mt-100 pb-32">
        ...
        <h1 class="h1 h1-bigger text-center max-600 m-0-auto mt-8 mb-100">Panel de administración de concepto</h1>

        <div class="shortcuts-container">
            <a href="<?= route('admin.blog') ?>" class="admin-shortcut m-0-auto">
                <p>Administrar entradas del blog</p>
            </a>

            <a href="<?= route('admin.user') ?>" class="admin-shortcut m-0-auto">
    ...
    <section class="container mt-100 mb-100">
        <h2 class="h2 mb-24">Estadísticas</h2>

        <h3 class="h3 mb-40">Cursos más vendidos</h3>
                ...
                <li class="course-card">
                    <a class="anchor-detail" href="<?= route('web.courses.detail', ['id' => $course->course_id]) ?>"
                        ...
                        <div class="card-content">
                            ...
                            <p class="paragraph fs-6 text-secondary">Cursos vendidos: {{ $course->total_sales }}</p>
                        </div>
                    </a>
                </li>
            @endforeach
